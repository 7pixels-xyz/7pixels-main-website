...
export default function Manifesto() {
    ...
    return (
        <section ref={containerRef} className="h-screen w-full bg-[#1c2226] text-cream relative flex flex-col justify-center items-center px-4 md:px-24 overflow-hidden py-24 md:py-0">
