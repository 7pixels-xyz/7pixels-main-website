...
export default function Performance() {
    return (
        <section className="py-24 md:py-32 bg-[#1c2226] text-cream relative overflow-hidden flex flex-col justify-center">
            ...
            <div className="px-4 md:px-24 mb-24 relative z-10 w-full flex flex-col md:flex-row md:items-end justify-between gap-8">
                <div className="max-w-xl">
                    ...
                    <motion.h2
                        ...
                        className="text-5xl md:text-7xl font-serif text-cream tracking-tight"
                    >
                        Engineered Metrics.
                    </motion.h2>
                </div>
                ...
                <div className="flex flex-col md:flex-row w-full">
                    {stats.map((stat, idx) => (
                        <motion.div
                            ...
                            className="flex-1 border-b md:border-b-0 md:border-r border-cream/20 last:border-0 p-8 md:p-12 relative group overflow-hidden flex flex-col justify-between min-h-[350px]"
                        >
                            {/* Hover Sweeper */}
                            ...
                            <div className="relative z-10 mt-auto">
                                <div className="text-7xl md:text-[8rem] font-serif tracking-tighter leading-none mb-6 text-cream group-hover:scale-105 transition-transform duration-700 origin-bottom-left">
